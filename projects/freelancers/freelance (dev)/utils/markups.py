...
want_learn = types.InlineKeyboardMarkup()
want_learn.add(
    types.InlineKeyboardButton(buttons['want_learn'], callback_data='want_learn')
)
train2 = types.InlineKeyboardMarkup()
train2.add(
    types.InlineKeyboardButton(buttons['channel'], callback_data='services:my_channel'),
    types.InlineKeyboardButton(buttons['proffessional'], callback_data='services:proffessional'),
)
...
inline_buy_train.add(types.InlineKeyboardButton("Купить", callback_data="services:train_buy"))